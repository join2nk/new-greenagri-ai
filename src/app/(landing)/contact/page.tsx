...
function ContactUsMethodsSection() {
  return (
    <Section background="white" padding="xl">
      <div className="text-center mb-16">
        ...
        <BodyText className="max-w-3xl mx-auto text-xl text-gray-600">
          Choose the most convenient way to reach us. Our dedicated teams are ready to assist you
          with all your rice business requirements.
        </BodyText>
      </div>
        ...
        {contactMethods.map((method, index) => (
          <div key={index} className="group">
            <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-green-200 transform hover:-translate-y-2 text-center">
              <div
                className={`w-16 h-16 bg-gradient-to-br ${method.color} rounded-2xl flex items-center justify-center text-3xl text-white mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
              >
                {method.icon}
              </div>
    ...
    <Section background="gradient" padding="xl">
      <div className="grid lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-8">
          <div>
            <CardTitle color="white" className="mb-8 text-3xl">
              Our Locations
            </CardTitle>
            <BodyText color="white" className="mb-8 text-lg">
              Visit our facilities or reach out to our teams at these locations for direct
          ...
          {offices.map((office, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-lg p-8 rounded-3xl shadow-xl border border-white/20">
              <div className="flex items-start space-x-6">
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${office.color} rounded-2xl flex items-center justify-center text-3xl text-white shadow-lg`}
                >
                  {office.icon}
                </div>
