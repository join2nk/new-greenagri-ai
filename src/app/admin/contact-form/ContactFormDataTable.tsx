"use client"
/*
todo:: show only first 100 characters of message in the table with ... at the end
todo:: on clicking the eye icon show the full message in a modal 
todo:: delete icon opens a confirmation modal before deleting
